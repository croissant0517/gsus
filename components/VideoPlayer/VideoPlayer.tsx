...
const VideoPlayer = ({ src, type }: Props) => {
  ...
  const toggleFullscreen = () => {
    ...
    function closeFullscreen() {
      ...
      } else if (forkDocument.webkitExitFullscreen) {
        /* Safari */
  ...
  return (
    <div className={styles.videoPlayerContainer} id="player">
      <video
      ...
      <div className={styles.showControler}>
        {loading ? (
          ...
          <React.Fragment>
            <div
              className={
                isPlaying
                  ? styles.centerPlayPauseButtonActive
        ...
        {/* custom UI */}
        <div
          className={styles.controlerContainer}
          style={{ bottom: fullscreen ? '0px' : '5px' }}
        >
          {/* progress */}
          <input
            name="currentTime"
          ...
          <div className={styles.controlers}>
            ...
            <div className={styles.rightControler}>
              ...
              {/* fullscreen icon */}
              <div className={styles.fullscreenIcon} onClick={toggleFullscreen}>
